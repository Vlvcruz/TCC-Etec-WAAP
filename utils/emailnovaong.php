<?php
    ...
    try {
        ...
        $mail->isHTML(true);
        $mail->Subject = 'Pedido registrado';
        $mail->Body="
        <meta charset='utf-8'>
        <div><div class='adM'>
        </div><table width='100%'>
                                ...
                                <table width='460' cellpadding='0' cellspacing='0' border='0'>
                                    ...
                                    <tr>
                                        <td bgcolor='#ececec' style='padding:10px 30px'>
                                            <div style='font-family:Roboto,Tahoma,Arial,Helvetica,sens-serif;font-weight:300;color:#6b6b6b;margin:7px 0px 7px 0px;font-size:1.1em'>Recebemos seu pedido, o seu cadastro se encontra em análise para que possa passar por uma validação.<br></div>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td bgcolor='#ececec' style='padding:10px 30px'>
                                            <div style='font-family:Roboto,Tahoma,Arial,Helvetica,sens-serif;font-weight:300;color:#6b6b6b;margin:15px 0px 15px 0px;font-size:1.1em'><br>Obrigado por escolher nossa plataforma!</div>
                                        </td>
                                    </tr>
