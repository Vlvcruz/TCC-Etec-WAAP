...
<body>
  ...
  <div class="container marketing">
    ...
    <div class="row">
      <!-- /.col-lg-4 -->
      <div class="col-lg-4">
        <img class="bd-placeholder-img rounded-circle" width="140" height="140" src="profiles/5.jpeg" role="img" aria-label="Placeholder: 140x140" preserveAspectRatio="xMidYMid slice" focusable="false">
        <title>Placeholder</title>
        <rect width="100%" height="100%" fill="#777" /></img>

        <h2>Bryan Palácio</h2>
        <p>Alguns anjos não têm asas, têm patas.</p>
        <p>
          <a class="icons" href="https://github.com/RyanPereiraS" target="_newblank">
            <ion-icon name="logo-github"></ion-icon></a>
          <a class="icons instagram" href="https://www.instagram.com/bryanrubinho/" target="_newblank">
            <ion-icon name="logo-instagram"></ion-icon></a>
          <a class="icons instagram" href="https://twitter.com/BryanRubinho" target="_newblank">
            <ion-icon name="logo-twitter"></ion-icon></a>
        </p>
      </div><!-- /.col-lg-4 -->

      <div class="col-lg-4 seglinha">
        <img class="bd-placeholder-img rounded-circle" width="140" height="140" src="profiles/3.jpeg" role="img" aria-label="Placeholder: 140x140" preserveAspectRatio="xMidYMid slice" focusable="false">
        <title>Placeholder</title>
        <rect width="100%" height="100%" fill="#777" /></img>
        <h2>Rafael Neves</h2>
        <p>Adotar é amar de graça.</p>
        <p>
          <a class="icons" href="https://github.com/RyanPereiraS" target="_newblank">
            <ion-icon name="logo-github"></ion-icon></a>
          <a class="icons instagram" href="https://www.instagram.com/ryan.pereirasilva/" target="_newblank">
            <ion-icon name="logo-instagram"></ion-icon></a>
          <a class="icons instagram" href="https://twitter.com/PereiraRyanS" target="_newblank">
            <ion-icon name="logo-twitter"></ion-icon></a>
        </p>
      </div><!-- /.col-lg-4 -->
      <div class="col-lg-4">
        <img class="bd-placeholder-img rounded-circle" width="140" height="140" src="profiles/4.jpeg" role="img" aria-label="Placeholder: 140x140" preserveAspectRatio="xMidYMid slice" focusable="false">
        <title>Placeholder</title>
        <rect width="100%" height="100%" fill="#777" /></img>
        <h2>Raul Germano</h2>
        <p>Quem abandona não tem raça.</p>
        <p>
          <a class="icons" href="https://github.com/RyanPereiraS" target="_newblank">
            <ion-icon name="logo-github"></ion-icon></a>
          <a class="icons instagram" href="https://www.instagram.com/off.germano/" target="_newblank">
            <ion-icon name="logo-instagram"></ion-icon></a>
          <a class="icons instagram" href="https://twitter.com/OffGermano" target="_newblank">
            <ion-icon name="logo-twitter"></ion-icon></a>
        </p>
      </div><!-- /.col-lg-4 -->

      <div class="col-lg-4">
        <img class="bd-placeholder-img rounded-circle" width="140" height="140" src="profiles/1.jpeg" role="img" aria-label="Placeholder: 140x140" preserveAspectRatio="xMidYMid slice" focusable="false">
        <title>Placeholder</title>
        <rect width="100%" height="100%" fill="#777" /></img>
        <h2>Ryan Pereira</h2>
      ...
      <div class="col-lg-4 seglinha">
        <img class="bd-placeholder-img rounded-circle" width="140" height="140" src="profiles/6.jpeg" role="img" aria-label="Placeholder: 140x140" preserveAspectRatio="xMidYMid slice" focusable="false">
        <title>Placeholder</title>
        <rect width="100%" height="100%" fill="#777" /></img>
        <h2>Vitor Leon</h2>
        <p>Ajudar um animal de rua vai fazer bem a ele. Mas vai fazer muito melhor a você!</p>
        <p>
          <a class="icons" href="https://github.com/Vlvcruz" target="_newblank">
            <ion-icon name="logo-github"></ion-icon></a>
          <a class="icons instagram" href="https://www.instagram.com/pse_leon/" target="_newblank">
            <ion-icon name="logo-instagram"></ion-icon></a>
          <a class="icons instagram" href="https://www.instagram.com/pse_leon/" target="_newblank"></a>
        </p>
      </div><!-- /.col-lg-4 -->
    </div><!-- /.row -->
  </div><!-- /.row -->
