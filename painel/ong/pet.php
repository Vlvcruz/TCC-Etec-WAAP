...
<body>
    ...
    <section class='home-section'>
        ...
        if(isset($_GET['animal'])){
            $vacinas = "";
            $sql = "SELECT *, r.raca as racanome FROM animal a INNER JOIN ong o on o.id_ong = a.id_ong INNER JOIN raca r on r.id_raca = a.raca WHERE id_animal = $_GET[animal] AND a.id_ong = $_SESSION[id_ong]";
            
            $vacinasql = "SELECT v.vacina as vacina FROM vacina_animal va INNER JOIN vacina v ON v.id_vacina = va.id_vacina WHERE id_animal = $_GET[animal]";
            $exe = mysqli_query($conexao, $sql);

            if(mysqli_num_rows($exe) != 1) echo "<script>location.href='pet.php'</script>";
            $exevacinas = mysqli_query($conexao, $vacinasql);
            
            
            while($vacinasfetch = mysqli_fetch_array($exevacinas)){ 
                $vacinas .= "$vacinasfetch[vacina], ";
            }
                            ...
                            <table class='table table-hover'>
                                ...
                                <thead>
                                    <tr>
                                        <td>
                                            <div class='img-espec'>
                                                <img class='card-img-top pet' src='../../assets/animais/$fetch[foto]'></td>
                                            </div
                                        <td></td>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <tr>
                                        <th scope='row' class='table-active''>Saúde</th>
                                        <td>
                                            $vacinas
                                        </td>
                                    </tr>
            ...
            while ($dados = mysqli_fetch_array($resultado_animal)){
                ...
                <div id='card_pet'>
                    <div class='row'>
                        <div class='col'>
                            <div class='card'>
                                <img class='card-img-top geral'  styles='width:100px; heigth:100px;' src='../../assets/animais/$dados[foto]'>
                                <div class='card-body'>
