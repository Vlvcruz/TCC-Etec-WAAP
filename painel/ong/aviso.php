...
<body>
    ...
    <?php
        if (isset($_POST['id_warn'])) {
            ...
            <div class='jumbotron'>
                <br>
                <h1 class='media-heading'>$fetch[aviso_titulo]</h1>
                <p class='lead'></p>
                <hr>
            </div>
            ...
            <div class='well'>
                <div class='media'>
                    <a class='pull-left' href='aviso.php'>
                        <img class='media-object' width='250' style='border-radius: 50%;' src='../../assets/profiles/$fetch[id_usuario].jpeg'>
                    </a>
                    <div class='media-body'>
                    <br>
                        <p class='text-right'> Postado por: $fetch[nome]</p>
                        <p id='text_aviso'>$fetch[aviso_conteudo]</p>
                        <ul class='list-inline list-unstyled'>
                            <h5><li><span><i class='glyphicon glyphicon-calendar'></i> $post_date, $post_hour </span></li></h5>
                            <li>
            ...
            echo "
                    ...
                    <div class='media'>
                        <div class='col-md-10 blogShort'>
                            ...
                            <img src='../../assets/profiles/$aviso[id_usuario].jpeg' alt='post img' width='100' class='pull-left img-responsive thumb margin10 img-thumbnail'>
                            ...
                            <article><p>
                                ...
                                <form class='warn' action='aviso.php' method='post'>
                                    ...
                                    <a href='#' class='btn btn-outline-success' onclick='this.parentNode.submit()'>Continuar Leitura</a>
                                </form>  
                            </p>
                            </article>
