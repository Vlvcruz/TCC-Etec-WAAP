<?php
	...
	$query_animal = "SELECT * FROM animal WHERE id_animal = $idanimal AND id_ong = $_SESSION[id_ong]";

	$exec_animal = mysqli_query($conexao, $query_animal);
    if(mysqli_num_rows($exec_animal) != 1){
        echo "<script> 
            location.href='./';
        </script>";
    }
            ...
            <div class="col">
                ...
                <form method='POST' enctype='multipart/form-data'>
					...
					<?php
						...
						$queryvac = "SELECT id_vacina, vacina FROM vacina WHERE especie = $fetch_animal[6] ORDER BY vacina ASC";
