			...
			<div id="filtro">
				<div class="row">
					...
					<div class="col-md-3 col-sm-6 col-xs-12">
						<select class="form-select" aria-label="Default select example" name='porte'>
							<option value='n'>Selecione...</option>
					...
					<div class="col-md-3 col-sm-4 col-xs-12">
						<select class="form-select" aria-label="Default select example" name='espec'>
							<option value='n'>Selecione...</option>
				...
				<div class="d-grid gap-2 col-6 mx-auto">
					<br>
					<button type="submit" id="filtrar" class="btn btn-outline-primary" name="" value="filtrar">filtrar</button>
				</div>
			</div>
		</form>
		</div>
			...
			<div class="row">
				<div class="col">
					...
					if (!empty($_GET)) {
						...
						if (isset($_GET["sexo"]) && $_GET["sexo"] != "n") {
							$sexo = $_GET["sexo"];
							$queryongs .= " AND a.sexo = '$sexo'";
						}
						if (isset($_GET['porte']) && $_GET["porte"] != "n") {
							$porte = $_GET["porte"];
							$queryongs .= " AND a.porte = '$porte'";
						}
						if (isset($_GET['espec']) && $_GET["espec"] != "n") {
							$espec = $_GET['espec'];
					...
					while ($dadosong = mysqli_fetch_array($resultado_animais)) {
						echo "
							...
							<div class='card-body'>
								...
								<p class='card-text' style='font-size:14px'>$dadosong[nomeong]</p>
