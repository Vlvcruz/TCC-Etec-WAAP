                        ...
                        <form action="" method="post">
                            <div class="jumbotron" id="camp_alterar">
                                ...
                                if ($privilegio == 1) {
                                    ...
                                    Possui uma ONG e deseja cadastrar ela no site? clique no botão abaixo.
                                    </p>
...
if (isset($_POST['alterardados'])) {
    ...
    if ($exe) {
        $ch = curl_init();
        curl_setopt($ch, CURLOPT_URL, "http://$host:$port/waap_oficial/web3/utils/encerrarconta.php");
